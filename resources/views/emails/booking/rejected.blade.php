...
@section('content')
    ...
    <p style="margin:0 0 24px; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:15px; line-height:24px; color:#3f3d37;">
        We reviewed the payment for booking <strong style="color:#112250;">{{ $summary['code'] }}</strong>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; margin:0 0 26px; background-color:#fdeceb; border-left:3px solid #d33a32; border-radius:8px;">
            <tr>
                <td style="padding:16px 18px;">
                    ...
                    <p style="margin:0; font-family:'Segoe UI',Helvetica,Arial,sans-serif; font-size:14px; line-height:22px; color:#3f3d37;">
                        {{ $reason }}
                    </p>
                </td>
            </tr>
