...
<head>
    ...
    <title inertia>{{ config('app.name', 'The Paddle Room') }}</title>
    ...
    <meta name="theme-color" content="#112250">
...
<body class="h-full font-sans antialiased bg-ivory-100 text-ink-900">
    @inertia
</body>
</html>
